    ...
    function onLocationFound(e) {
        ...
        L.geoJson(ptsWithin_clinic, {
            pointToLayer: function (f, latlng) {
                ...
                return L.marker(latlng, {
                    icon: ic_clinic,
                }).bindPopup('<table class="table"><caption>' + f.properties.name + '</caption> <tr><td>ระยะทาง : </td><td>' + f.properties.dis + ' km  </td></tr><tr><td><a href="https://www.google.com/maps/dir/' + get_latlng[1] + ',' + get_latlng[0] + '/' + Number(f.properties.lat) + ',' + Number(f.properties.lon) + '/data=!3m1!4b1!4m2!4m1!3e0" target="_blank">เส้นทาง</a> </td><td><a href="http://gishealth.moph.go.th/clinic/info.php?maincode=' + f.properties.main_code + '" target="_blank">ข้อมูลเพิ่มเติม</a> </td></tr></table>');
            }
        }).addTo(markerClusterGroup)
