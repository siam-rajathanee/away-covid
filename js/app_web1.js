...
new Vue({
    ...
    mounted() {
        axios
            .get('http://mapedia.co.th/demo/get_point.php?date=7')
...
function get_tracking() {
    ...
    $.ajax({
        url: 'http://mapedia.co.th/demo/add_tracking.php?type=tracking',
        method: 'post',
        data: ({
            pictureUrl: pictureUrl,
            userId: userId,
...
$("#form_setting").submit(function (event) {
    ...
    $.ajax({
        url: 'http://mapedia.co.th/demo/get_point.php?date=' + date,
        method: 'get',
        success: function (data) {
