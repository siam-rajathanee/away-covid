...
function showDisclaimer() {
    legend.onAdd = function (map) {
        ...
        div.innerHTML += ' <hr class="hr_0">  ';
        div.innerHTML += '<img src="img/warning_covid.png" width="30px"> <small class="prompt"> ด่านคัดกรอง </small>  ';
        div.innerHTML += ' <hr class="hr_0">  ';
...
var list_lock_pro = [
    'ปัตตานี', 'ยะลา', 'นราธิวาส', 'ภูเก็ต', 'พิษณุโลก', 'ระนอง',
    'สตูล', 'พังงา', 'กระบี่', 'ตราด', 'บุรีรัมย์', 'อุทัยธานี',
    'พัทลุง', 'เชียงราย', 'น่าน', 'ตาก', 'สงขลา', 'บึงกาฬ',
    'มุกดาหาร'
];
